...
- [صيغة النهاية الإجبارية - الأزرار القابلة للنقر]: يجب أن تختم رسالتك دائماً وأبداً بوضع المقترحات القضائية باستخدام الكلمة المفتاحية [SUGGESTION] في بداية السطر. يُمنع كتابة أي نص حواري (مثل "يُستحسن مراجعة...") بعد هذه الأسطر، لأن النظام برمجياً يبحث عن هذه الكلمة المفتاحية لتحويلها إلى أزرار قابلة للنقر.
  مثال إلزامي لنهاية الرد (يجب أن يكون بالضبط هكذا):
